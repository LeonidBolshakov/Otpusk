...
def run_once() -> int:
    ...
    try:
        ...
        app.common.error("-----", TEXT_ERROR[7], logging.CRITICAL)
        raise
    ...
    out_path = Path(app.parameters["output_file_path"])
    ...
    try:
        ...
        app.common.error("-----", TEXT_ERROR[8], logging.CRITICAL)
        app.return_code = 1

    if app.return_code:
        app.common.error("-----", TEXT_ERROR[6], logging.CRITICAL)
